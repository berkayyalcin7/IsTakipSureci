...
namespace IsTakipSureci.Business.Concrete
{
    ...
    {
        public byte[] ExcelConvert<T>(List<T> list) where T : class, new()
        {
            var excelPackage = new ExcelPackage();
            var excelBlank = excelPackage.Workbook.Worksheets.Add("Calisma1");

            // A1'den sonra koleksiyonu yükle , Başlık true , Tablo Stili
        ...
        public string PdfConvert<T>(List<T> list) where T : class, new()
        {
